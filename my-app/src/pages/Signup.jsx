...
const Signup = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      username: Yup.string()
        ...
        .min(
          6,
          'Username much be minimum of 6 characters long, username too short! '
        ),
      password: Yup.string()
        .required('Password Required')
        .min(
          8,
          'Password much be minimum of 5 characters long, password too short! '
        ),
    }),
  ...
  return (
    <div className="SignupImg">
      ...
      >
        <Heading color="#421413">Sign Up!</Heading>
